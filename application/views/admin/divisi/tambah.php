...
<div class="main-content">
  <section class="section">
    ...
    <div class="section-body">
      <div class="card">
        <div class="card-body">
          <?php echo form_open_multipart(base_url('admin/divisi/add')); ?>
          <div class="col-md-8">
            <div class="form-group form-group-lg">
              <label>Nama Divisi</label>
              <input type="text" name="nama_divisi" class="form-control" placeholder="Nama divisi" required="required" value="<?php echo set_value('nama_divisi') ?>" />
            </div>
            <div class="form-group form-group-sm">
              <label>Gambar Divisi</label>
              <input type="file" name="gambar_divisi" class="form-control" required="required" />
            </div>
          </div>
