...
<div class="container">
    <div class="row mt-5 row-blog">
        <div class="col-md-8 mx-auto">
            <form action="<?php echo site_url('blog'); ?>" method="post">
...
<div class="section-news">
    <div class="container">
        <div class="row mt-5 mb-5">
            <?php foreach ($blog_all as $blog_all) { ?>
                <div class="col-lg-4 col-sm-6 mb-4 portfolio-item col-blog">
                    <div class="card h-100">
                        <a href="<?php echo base_url('blog/' . $blog_all->url); ?>"><img class="card-img-top lazyload" data-src="<?php if ($blog_all->gambar_blog == null) {
                                                                                                                                        echo base_url('assets/img/img_placeholder_cc.svg');
                                                                                                                                    } else {
                                                                                                                                        echo base_url('assets/upload/image/thumbs/blog/' . $blog_all->gambar_blog);
                                                                                                                                    } ?>" src="<?php echo base_url() ?>assets/img/img_placeholder_cc.svg" alt="gambar-<?php echo $blog_all->judul; ?>"></a>
                        <div class="card-body">
                            <h5 class="card-title">
                                <a class="text-dark text-decoration-none" href="<?php echo base_url('blog/' . $blog_all->url); ?>"><?php echo $blog_all->judul; ?></a>
                            </h5>
                        </div>
                        <div class="card-footer border-0" style="background: none">
                            <small class="text-muted">
                                <?php if ($blog_all->update_blog != null) {
                                    echo '<strong>Diupdate pada ' . date('d F Y', $blog_all->update_blog) . '</strong>';
                                } else {
                                    echo date('d F Y', $blog_all->tanggal);
                                } ?>
            ...
            <div class="col-lg-8 col-md-10">
                <?php foreach ($blog_all as $blog_all) { ?>
                    <div class="row" style="margin-top: 100px">
                        <div class="col-md-5">
                            <img src="<?php echo base_url() ?>assets/upload/image/thumbs/blog/<?php echo $blog_all->gambar_blog ?>" style="max-width: 300px" alt="...">
                        </div>
                        <div class="col-md-7">
                            <h5>FDFDFD</h5>

                            <p><?php echo character_limiter($blog_all->isi, 280); ?></p>
                        </div>
                    </div>
                <?php } ?>
            </div>
            ...
            <div class="col-lg-9 col-md-10 mx-auto">
                ...
                <?php foreach ($blog_all as $blog_all) { ?>
                    <div class="post-preview">
                        <a class="text-decoration-none" href="<?php echo base_url('blog/' . $blog_all->url); ?>">
                            <h2 class="post-title">
                                <?php echo $blog_all->judul ?>
                            </h2>
                            <h3 class="post-subtitle">
                                <?php echo character_limiter($blog_all->isi, 280); ?>
                            </h3>
                        </a>
                        <p class="post-meta">Oleh Admin CC pada <?php echo date('d F Y', strtotime($blog_all->tanggal)); ?></p>
                    </div>
                    <hr>
                <?php } ?>
            </div>
				...
				<?php foreach ($portfolio_all as $portfolio_all) { ?>
					<div class="col-lg-3 col-md-4 col-sm-6 mb-4 pl-3">
						<div class="card card-news h-100">
							...
							<div class="card-body">
								<h5 class="card-title">
									<a href="<?php echo base_url('portfolio/portfolio_read/' . $portfolio_all->id_blog); ?>">
										<?php echo $portfolio_all->judul ?>
									</a><br>
									<a class="text-small text-muted disabled" aria-disabled="true" href="<?php echo base_url('portfolio/portfolio_read/' . $portfolio_all->id_blog); ?>#disqus_thread"></a>
								</h5>
								<p class="card-text"><?php echo character_limiter($portfolio_all->isi, 100); ?></p>
								<a href="<?php echo base_url('portfolio/portfolio_read/' . $portfolio_all->id_blog); ?>" class="btn btn-primary">Read More</a>
							</div>
						</div>
					</div>
				<?php } ?>
					...
					<?php foreach ($portfolio_all as $portfolio_all) { ?>
															<div class="portfolio-box col-md-6 col-sm-6 col-xs-12">
																<div class="box0">
																	...
																	<a href="<?php echo base_url('portfolio/portfolio_read/' . $portfolio_all->id_blog); ?>"><h3><?php echo $portfolio_all->judul ?></h3></a>
																	<div class="box1">
																	...
																	<span><a href="<?php echo base_url('portfolio/portfolio_read/' . $portfolio_all->id_blog); ?>" class="btn btn-primary btn-xs">Read more</a></span>
																</div>
															</div>
					<?php } ?>
				</div>
