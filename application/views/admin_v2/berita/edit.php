			...
			<div class="section-body">
				<div class="card">
					<div class="card-body">
						...
						<div class="row">
							<div class="col-md-4">
								<div class="card shadow-none" style="border: 1px dashed rgba(0, 0, 0, .3); background-color: #DFE3ED">
									<div class="card-body">
										<p class="p-5 text-center text-muted">Belum ada sampul</p>
									</div>
								</div>
							</div>
						</div>
							...
							<div class="col-md-6">
								<div class="form-group form-group-lg">
									...
									<input type="text" name="url" class="form-control <?php if ($this->form_validation->run() == FALSE && form_error('url') != null) {
																							echo "is-invalid";
																						} ?>" placeholder="Judul Berita" value="<?php echo $berita->url; ?>" /><br>
							...
							<div class="col-md-3">
								<div class="form-group form-group-lg">
									...
									<select name="jenis_berita" class="form-control">
										...
										<option value="Artikel" <?php if ($berita->jenis_berita == "Artikel") {
																	echo "selected";
																} ?>>Artikel</option>
						...
						<div class="row">
							<div class="col-md-12">
								<div class="form-group form-group-lg">
									...
									<textarea id="summernote" name="isi" class="form-control" placeholder="Isi berita"><?php echo $berita->isi ?></textarea>
								</div>
							</div>
						</div>
