                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-sm table-bordered table-striped" id="dataNews" width="100%" cellspacing="0">
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr class="table-bordered">
                                                    ...
                                                    <td width="10">
                                                        <div class="btn-group mb-2 mr-2">
                                                            ...
                                                            <div class="dropdown-menu">
                                                                <a href="<?php echo base_url() ?>admin/berita/update/<?php echo $berita->id_berita ?>" class="dropdown-item"><i class="feather icon-edit-2 mr-2"></i>Edit</a>
                                                                <?php if ($berita->status_berita == 'Publish') { ?>
                                                                    <a href="<?php echo site_url('admin/berita/archive/' . $berita->id_berita); ?>" class="dropdown-item"><i class="feather icon-file-minus mr-2"></i>Archive</a>
                                                                <?php } else { ?>
                                                                    <a href="<?php echo site_url('admin/berita/unarchive/' . $berita->id_berita); ?>" class="dropdown-item"><i class="feather icon-file-plus mr-2"></i>Unarchive</a>
                                                                <?php } ?>
                                                                <a href="<?php echo site_url('admin/berita/delete/' . $berita->id_berita) ?>" class="dropdown-item"><i class="far fa-trash-alt mr-3"></i>Delete</a>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <td> <?php if ($berita->update_berita == null) { ?>
                                                        ...
                                                        <?php } ?></td>
                                                    <td><?= $berita->jenis_berita ?> &mdash; <strong><?= $berita->status_berita ?></strong></td>
                                                </tr>
                                            <?php endforeach  ?>
                                        </tbody>
                                    </table>
